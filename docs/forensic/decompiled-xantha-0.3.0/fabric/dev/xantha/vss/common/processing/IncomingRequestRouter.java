...
/* JADX INFO: loaded from: voxy-server-side-fabric-0.3.0.jar:META-INF/jars/common-0.3.0.jar:dev/xantha/vss/common/processing/IncomingRequestRouter.class */
class IncomingRequestRouter<PS extends PlayerStateAccess> {
    ...
    /* JADX INFO: loaded from: voxy-server-side-fabric-0.3.0.jar:META-INF/jars/common-0.3.0.jar:dev/xantha/vss/common/processing/IncomingRequestRouter$DiskReadSubmitter.class */
    @FunctionalInterface
    interface DiskReadSubmitter {
        void submit(UUID uuid, int i, String str, int i2, int i3, long j);
    }

    /* JADX INFO: loaded from: voxy-server-side-fabric-0.3.0.jar:META-INF/jars/common-0.3.0.jar:dev/xantha/vss/common/processing/IncomingRequestRouter$LoadedColumnSerializer.class */
    @FunctionalInterface
