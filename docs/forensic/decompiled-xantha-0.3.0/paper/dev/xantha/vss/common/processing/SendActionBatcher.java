...
/* JADX INFO: loaded from: voxy-server-side-paper-0.3.0.jar:dev/xantha/vss/common/processing/SendActionBatcher.class */
public final class SendActionBatcher {
    private final Map<UUID, PlayerBatch> batches = new HashMap();
    private static final int INITIAL_CAPACITY = 64;

    /* JADX INFO: loaded from: voxy-server-side-paper-0.3.0.jar:dev/xantha/vss/common/processing/SendActionBatcher$BatchConsumer.class */
    @FunctionalInterface
    ...
    /* JADX INFO: loaded from: voxy-server-side-paper-0.3.0.jar:dev/xantha/vss/common/processing/SendActionBatcher$PlayerBatch.class */
