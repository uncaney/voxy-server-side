...
/* JADX INFO: loaded from: voxy-server-side-fabric-0.3.0.jar:dev/xantha/vss/networking/server/SectionSerializer.class */
public final class SectionSerializer {
    private SectionSerializer() {
    }

    /* JADX INFO: loaded from: voxy-server-side-fabric-0.3.0.jar:dev/xantha/vss/networking/server/SectionSerializer$SectionInfo.class */
    private static final class SectionInfo extends Record {
        ...
        public final String toString() {
            return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, SectionInfo.class), SectionInfo.class, "index;sectionY;sectionPos;blLayer;hasBlockLight", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->index:I", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->sectionY:I", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->sectionPos:Lnet/minecraft/core/SectionPos;", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->blLayer:Lnet/minecraft/world/level/chunk/DataLayer;", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->hasBlockLight:Z").dynamicInvoker().invoke(this) /* invoke-custom */;
        }

        @Override // java.lang.Record
        public final int hashCode() {
            return (int) ObjectMethods.bootstrap(MethodHandles.lookup(), "hashCode", MethodType.methodType(Integer.TYPE, SectionInfo.class), SectionInfo.class, "index;sectionY;sectionPos;blLayer;hasBlockLight", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->index:I", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->sectionY:I", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->sectionPos:Lnet/minecraft/core/SectionPos;", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->blLayer:Lnet/minecraft/world/level/chunk/DataLayer;", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->hasBlockLight:Z").dynamicInvoker().invoke(this) /* invoke-custom */;
        }

        @Override // java.lang.Record
        public final boolean equals(Object o) {
            return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, SectionInfo.class, Object.class), SectionInfo.class, "index;sectionY;sectionPos;blLayer;hasBlockLight", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->index:I", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->sectionY:I", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->sectionPos:Lnet/minecraft/core/SectionPos;", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->blLayer:Lnet/minecraft/world/level/chunk/DataLayer;", "FIELD:Ldev/xantha/vss/networking/server/SectionSerializer$SectionInfo;->hasBlockLight:Z").dynamicInvoker().invoke(this, o) /* invoke-custom */;
        }
